...
2. Поместите .maFile файлы в папку maFiles (maFile должны иметь название steam_login.mafile, например, pupsik2000.mifile). Если есть необходимость в автоматическом массовом переименовании maFile - используйте скрипт - [maFile_renamer](https://github.com/Pirozhok40/maFile_renamer)
